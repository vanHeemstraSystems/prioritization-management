<template>
    <PrimaryButton class="open" icon="info" title="Open introduction" :tabindex="viewStore.introPanelVisible ? -1 : ''"
    ...
    <div ref="intro" class="intro" :class="{ visible: viewStore.introPanelVisible }">
        <div class="outer">
            <div class="inner">
                ...
                <p class="attribution">Powered by <a href="https://uclab.fh-potsdam.de/interactive-flowchart/"
                        target="_blank">Interactive Flowchart</a></p>
            </div>
        </div>
